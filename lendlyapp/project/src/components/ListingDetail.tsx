...
export default function ListingDetail({ item, onBack }: ListingDetailProps) {
  ...
  return (
    <div className="animate-[fadeIn_0.2s_ease]">
      <button
        onClick={onBack}
        className="inline-flex items-center gap-2 text-stone-600 hover:text-teal-700 font-medium mb-6"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <a
            ...
            className="mt-4 inline-flex items-center justify-center gap-2 w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold px-5 py-3 rounded-xl transition-colors"
          >
