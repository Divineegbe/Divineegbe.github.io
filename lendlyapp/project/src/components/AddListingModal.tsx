      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl my-8 animate-[fadeIn_0.2s_ease]">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="pt-2 border-t border-stone-100">
            <p className="font-semibold text-stone-700 mb-3">Your details</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 px-5 py-3 rounded-xl font-semibold text-stone-600 bg-stone-100 hover:bg-stone-200 transition-colors"
            >
              Cancel
            </button>
            <button
              type="submit" disabled={submitting}
              className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold text-white bg-teal-600 hover:bg-teal-700 disabled:opacity-60 transition-colors"
            >
...
const inputClass =
  'w-full px-4 py-2.5 rounded-lg border border-stone-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-100 outline-none transition-all text-stone-800 placeholder-stone-400';
